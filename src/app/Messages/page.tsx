        ...
        <div className="w-80 border-r border-gray-100 flex flex-col">
          ...
          <div className="p-4 border-b border-gray-100">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                className="block w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200"
